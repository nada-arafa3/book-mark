...
function urlValidation() {
    ...
    `;
		...
		urlcheck.innerHTML = `
    <p class="text-danger"> Whoa, you need to write it right  ...just copy and paste it it's not that hard 
    <br/>
    , I'll give you another chance. <i class="fa-regular fa-face-laugh-beam" ></i> </p>    `;
	}
}
